                            ...
                            <div class="col-lg-12">
                                <fieldset>
                                    <select class="js-example-basic-multiple text-white form-select"
                                        multiple="multiple" name="makanan" data-placeholder="Pilih Makanan & Level...">
                                        @forelse ($foods as $food)
                                            <option value="{{ $food->id }}">{{ $food->food }} LV {{ $food->level }}</option>

                                        @empty
                                            <option>Belum ada makanan & Level</option>
                                        @endforelse
                                    </select>
                                </fieldset>
                            </div>
