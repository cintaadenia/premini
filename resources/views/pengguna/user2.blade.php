                ...
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <div style="margin-right: 10px;">
                            <a href="#" id="addToCartBtn" style="color: #faf9fa; font-size: 24px; vertical-align: middle;"><i class="fas fa-cart-plus" style="color: #ffffff; font-size: 24px;"></i></a>
                        </div>
