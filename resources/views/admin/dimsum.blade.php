        ...
        <div class="card-body">
            ...
            <form action="{{ route('dimsum.create') }}" method="POST" id="dimsum" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="dimsum" name="dimsum" placeholder="Tambahkan Dimsum" value="{{ old('dimsum') }}"></input>
                            @error('dimsum')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="price" name="price" type="number" placeholder="Tambahkan Price" value="{{ old('price') }}"></input>
                            @error('price')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="stock" name="stock" type="number" placeholder="Tambahkan Stock" value="{{ old('stock') }}"></input>
                            @error('stock')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="image" name="image" type="file" placeholder="Upload Image"></input>
                            @error('image')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
